...
<body>
	<form action='ajout_gare.php' method='post'>
		Nom de la gare&nbsp: <input type='text' name='nom'></input> <br><br>
		Adresse&nbsp: Numero <input type='number' min='0' name='numero_rue'></input> Rue <input type='text' name='rue'></input><br><br>
