...
<body>
	<form action='ajout_trajet.php' method='post'>
		...
		Heure du départ&nbsp: <input name='heured' type='number' min='0' max='23'></input>:<input name='minuted' type='number' min='0' max='59'></input>:<input name='seconded' type='number' min='0' max='59'></input><br><br>
		Heure d'arrivée&nbsp: <input name='heurea' type='number' min='0' max='23'></input>:<input name='minutea' type='number' min='0' max='59'></input>:<input name='secondea' type='number' min='0' max='59'></input><br><br>
		Prix première classe (si existante sinon 0)&nbsp: <input type='number' name='prixprem' min='0' step='0.01'> </input><br><br>
		Prix seconde classe&nbsp: <input type='number' name='prixsec' min='0' step='0.01'> </input><br><br>
