...
<body>
    ...
    $tb_trajets = $db->query("SELECT num_trajet, gare_dep, heure_dep, gare_arr, heure_arr, prix_sec, prix_prem FROM trouverTrajet('$villeDep', '$villeArr', '$date') ORDER BY heure_dep");
    $liste_trains = $tb_trajets->fetchAll();

    echo "<form action='reservation_billet.php' method='POST'>";
    ...
    echo "<p>Je veux une assurance pour ce voyage <input type='checkbox' name='assurance' value='oui'></p>";
